...
export function FooterCta() {
  return (
    <footer className="border-t border-white/10 py-20 md:py-24 lg:py-32">
      <div className="mx-auto max-w-7xl px-4 md:px-6">
        <div className="mb-16 rounded-xl border border-white/10 bg-white/5 p-8 shadow-xl shadow-slate-950/50 ring-1 ring-inset ring-white/5 backdrop-blur-xl md:p-12">
          <div className="mx-auto max-w-2xl text-center">
            <h2 className="mb-4 text-3xl font-bold tracking-tight text-slate-50 md:text-4xl">
              Ready to see the code breathe?
            </h2>
            <p className="mb-8 text-base leading-relaxed text-slate-400">
              Start with the feature tour or jump straight into the playground.
            </p>
            <Button
              asChild
              size="lg"
              className={cn(
                "rounded-xl border-transparent bg-linear-to-r from-violet-600 to-violet-500 text-white shadow-lg shadow-violet-500/25 hover:shadow-violet-500/40",
              )}
            >
